...
I'm not Akamai so ill be waiting to see their report, but from what I can measure with overhead additions, the amps range from 70 to 150x.
...
int main(int argc, char *argv[ ])
{
	...
	int i = 0;
	head = NULL;
	fprintf(stdout, "Finding the yeet bois\n");
	int max_len = 128;
